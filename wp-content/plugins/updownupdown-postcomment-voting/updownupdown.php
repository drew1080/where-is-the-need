<?php
/*
 * Plugin Name: UpDownUpDown - Original
...
add_action( 'genesis_before_comment', 'custom_post_like_button');
function custom_post_like_button($author, $meta, $commenttext) {
  if( function_exists('up_down_comment_votes') ) { 
    up_down_comment_votes( get_comment_ID() );
  }
}
